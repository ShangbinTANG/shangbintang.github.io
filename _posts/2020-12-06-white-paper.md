...
<figure >
	<img src="/assets/images/VaxMap_publication_teaser.jpg"  style="width:100%;margin-left:auto;margin-right:auto" alt="Whitepaper">
...
<!-- 
In this research project, we estimated the driving (network traveling) distance from residents in the US to their closest potential COVID-19 vaccination providers, using a 1% random synthetic population sample (UTI link).  -->
